...
public class ExpenditureService {
    ...
    public ExpenditureModel create(ExpenditureModel e){
        ...
        if(eDb) throw new ExpenditureException.ConflictName();
    ...
    public Optional<ExpenditureModel> get(long id){
        ...
        if(eDb.isEmpty()) throw new ExpenditureException.NoExpenditure();
    ...
    public ExpenditureModel put(long id, ExpenditureModel e){
        ...
        if(nDb) throw new ExpenditureException.ConflictName();
