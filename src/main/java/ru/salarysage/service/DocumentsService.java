...
public class DocumentsService {
    ...
    // Защищенные поля службы для взаимодействия с проектами и утилитами расчетов
    ...
    // Метод для генерации Word документа на основе информации о проекте
    ...
    public byte[] generateWordPaySheetDocument(long id, HttpServletResponse response) throws IOException {
        ...
        // Обработка случая, если проект не найден
        if (p.isEmpty()) throw new PaySheetException.PaySheetNotFount();
